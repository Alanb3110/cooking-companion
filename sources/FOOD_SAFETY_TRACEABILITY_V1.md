...
|---|---|---|---|---|
| `FS-USDA-POULTRY-74C` | Chicken, turkey and duck reach at least 74 °C at the thickest/coldest measured point. | `chicken-satay-coconut-rice`, `glazed-chicken-skewers-rice`, `glazed-duck-sweet-potato-citrus`, `gochujang-honey-soy-chicken-rice`, `honey-sesame-ginger-chicken-udon`, `mild-jerk-chicken-rice-peas`, `smoked-chicken-shawarma-potatoes`, `smoked-honey-garlic-chicken-couscous`, `smoky-honey-soy-wings-potatoes-slaw`, `sweet-savory-turkey-zucchini-gratin`, `tandoori-chicken-basmati-raita`, `woodfire-chicken-fajitas` | USDA/FSIS specifies 165 °F = 73.9 °C for all poultry, including duck. The application rounds upward to 74 °C. | Probe placement and cold-spot selection remain operator-dependent. |
